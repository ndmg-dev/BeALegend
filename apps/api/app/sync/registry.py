...
REGISTRY: dict[str, SyncEntity] = {
    ...
    "training_plan": SyncEntity(
        nome="training_plan", model=TrainingPlan, schema_create=ExerciseCreate, schema_patch=None,
        somente_leitura=True,
    ),
    "plan_day": SyncEntity(
        nome="plan_day", model=PlanDay, schema_create=ExerciseCreate, schema_patch=None,
        somente_leitura=True,
    ),
    "plan_item": SyncEntity(
        nome="plan_item", model=PlanItem, schema_create=ExerciseCreate, schema_patch=None,
        somente_leitura=True,
    ),
    "cardio_protocol": SyncEntity(
        nome="cardio_protocol", model=CardioProtocol, schema_create=ExerciseCreate,
        schema_patch=None, somente_leitura=True,
    ),
    "session": SyncEntity(
        nome="session", model=Session, schema_create=SessionCreate, schema_patch=SessionPatch,
    ),
    "set_log": SyncEntity(
        nome="set_log", model=SetLog, schema_create=SetLogCreate, schema_patch=None,
        append_only=True, referencias=(("session_id", Session),),
    ),
    "cardio_log": SyncEntity(
        nome="cardio_log", model=CardioLog, schema_create=CardioLogCreate,
        schema_patch=CardioLogPatch, referencias=(("session_id", Session),),
    ),
    "body_metric": SyncEntity(
        nome="body_metric", model=BodyMetric, schema_create=BodyMetricCreate, schema_patch=None,
    ),
    "account": SyncEntity(
        nome="account", model=Account, schema_create=AccountCreate, schema_patch=AccountPatch,
    ),
    "category": SyncEntity(
        nome="category", model=Category, schema_create=CategoryCreate, schema_patch=CategoryPatch,
        referencias=(("pai_id", Category),),
    ),
    "recurring": SyncEntity(
        nome="recurring", model=Recurring, schema_create=RecurringCreate,
        schema_patch=RecurringPatch,
    ),
    "transaction": SyncEntity(
        nome="transaction", model=FinanceTransaction, schema_create=TransactionCreate,
        schema_patch=TransactionPatch,
        referencias=(
            ("account_id", Account), ("category_id", Category), ("recorrente_id", Recurring)
        ),
    ),
    "budget": SyncEntity(
        nome="budget", model=Budget, schema_create=BudgetCreate, schema_patch=BudgetPatch,
        referencias=(("category_id", Category),),
    ),
    "meal_plan": SyncEntity(
        nome="meal_plan", model=MealPlan, schema_create=MealPlanCreate,
        schema_patch=MealPlanPatch,
    ),
    "meal_slot": SyncEntity(
        nome="meal_slot", model=MealSlot, schema_create=MealSlotCreate,
        schema_patch=MealSlotPatch, referencias=(("meal_plan_id", MealPlan),),
    ),
    "meal_log": SyncEntity(
        nome="meal_log", model=MealLog, schema_create=MealLogCreate,
        schema_patch=MealLogPatch, referencias=(("slot_id", MealSlot),),
    ),
    "water_log": SyncEntity(
        nome="water_log", model=WaterLog, schema_create=WaterLogCreate, schema_patch=None,
    ),
    "habit": SyncEntity(
        nome="habit", model=Habit, schema_create=HabitCreate, schema_patch=HabitPatch,
    ),
    "habit_checkin": SyncEntity(
        nome="habit_checkin", model=HabitCheckin, schema_create=HabitCheckinCreate,
        schema_patch=HabitCheckinPatch, referencias=(("habit_id", Habit),),
    ),
    "goal": SyncEntity(
        nome="goal", model=Goal, schema_create=GoalCreate, schema_patch=GoalPatch,
    ),
}
